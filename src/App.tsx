...
const INITIAL_INVENTORY = [
  { name: 'Cups 12oz', quantity: 500, unit: 'pcs', lowStockThreshold: 50 },
  { name: 'Cups 16oz', quantity: 500, unit: 'pcs', lowStockThreshold: 50 },
  { name: 'Cups 22oz', quantity: 500, unit: 'pcs', lowStockThreshold: 50 },
  { name: 'Lemon', quantity: 100, unit: 'pcs', lowStockThreshold: 10 },
  { name: 'Calamansi', quantity: 300, unit: 'pcs', lowStockThreshold: 30 },
  { name: 'Yakult', quantity: 50, unit: 'bottles', lowStockThreshold: 5 },
  { name: 'Nata de Coco', quantity: 20, unit: 'kg', lowStockThreshold: 2 },
  { name: 'Popping Boba', quantity: 20, unit: 'kg', lowStockThreshold: 2 },
  { name: 'Green Apple Syrup', quantity: 10, unit: 'liters', lowStockThreshold: 1 },
  { name: 'Strawberry Syrup', quantity: 10, unit: 'liters', lowStockThreshold: 1 },
  { name: 'Mango Syrup', quantity: 10, unit: 'liters', lowStockThreshold: 1 },
  { name: 'Kiwi Syrup', quantity: 10, unit: 'liters', lowStockThreshold: 1 },
  { name: 'Peach Syrup', quantity: 10, unit: 'liters', lowStockThreshold: 1 },
];
  ...
  return (
    ...
    >
      {view === 'admin' && permissions.includes('reports.view') ? (
        <AdminDashboard permissions={permissions} theme={theme} />
      ) : permissions.includes('orders.create') ? (
        <POS user={userData} theme={theme} />
      ) : (
