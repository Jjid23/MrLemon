...
export function AdminDashboard({ permissions, theme }: AdminDashboardProps) {
               ...
               <ResponsiveContainer width="100%" height="80%">
                 <BarChart data={chartData}>
                   ...
                   <XAxis 
                     ...
                     axisLine={false} 
                     tickLine={false} 
                     tick={{ fontSize: 10, fontWeight: 700, fill: theme === 'dark' ? '#57534e' : '#A8A29E' }}
                     dy={10}
                   />
                   <YAxis 
                     axisLine={false} 
                   ...
                   />
                   <Tooltip 
                     cursor={{ fill: theme === 'dark' ? '#1c1917' : '#f9f8f3' }}
                     contentStyle={{ 
                        borderRadius: '24px', 
                        border: 'none', 
                   ...
                   <Bar dataKey="value" radius={[12, 12, 12, 12]}>
                      {chartData.map((entry: any, index: number) => (
                        <Cell key={`cell-${index}`} fill={index === chartData.length - 1 ? '#F4D03F' : (theme === 'dark' ? '#292524' : '#e7e5e4')} />
                      ))}
                   </Bar>
                 </BarChart>
               </ResponsiveContainer>
