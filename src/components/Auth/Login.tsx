    ...
    <div className="min-h-screen flex items-center justify-center bg-natural p-4 font-sans text-stone-900 relative selection:bg-lemon/30">
      ...
      >
        <div className="flex flex-col items-center text-center space-y-6 mb-10">
          ...
          >
            <img src="/Mrlemonlogo.jpg" alt="Mr Lemon Logo" className="w-full h-full object-cover" />
          </motion.div>
          <div>
        ...
        <div className="relative my-12">
          <div className="absolute inset-0 flex items-center">
            <div className="w-full border-t-2 border-stone-100"></div>
          </div>
          <div className="relative flex justify-center text-xs font-black uppercase tracking-[0.3em]">
            <span className="bg-white px-8 text-stone-300">Or Continue With</span>
          </div>
        </div>
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full flex items-center justify-center gap-5 py-6 bg-white border-2 border-stone-100 hover:border-lemon text-stone-900 font-black text-xs uppercase tracking-widest rounded-[32px] transition-all active:scale-95 disabled:opacity-50"
        >
